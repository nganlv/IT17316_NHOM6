...
public class KhachHangDomain {
    ...
    public KhachHangDomain(String maKH, String hoTen, String gioiTinh, String sdt, String diaChi, String email, String diem, Date ngaysinh, Date ngayTao, Date ngayHetHan) {
        this.maKH = maKH;
        this.hoTen = hoTen;
