...
public class SanPham_BanHang {
   ...
   private int soLuong;
    ...
    public SanPham_BanHang(String ma, String ten, String donGia, String giamGia, String mauSac, String chatLieu, String kichThuoc, String loai, String gioiTinh, String kieuMay, int soLuong) {
        this.ma = ma;
        this.ten = ten;
        this.donGia = donGia;
