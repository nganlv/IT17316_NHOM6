...
import Services.impl.XuatXuServiceImpl;
...
public class QLXuatXu extends javax.swing.JFrame {
    final XuatXuServiceImpl cvService = new XuatXuServiceImpl();
    ...
    public void loadTextField(){
        ...
        txtMaXuatXu.setText(tblXuatXu.getValueAt(index, 0).toString());
        txtTenXuatXu.setText(tblXuatXu.getValueAt(index, 1).toString());
    }
    
    public XuatXu getData(){
        XuatXu cv = new XuatXu();
        cv.setMa(txtMaXuatXu.getText().trim());
        cv.setTen(txtTenXuatXu.getText().trim());
        return cv;
    }
    
    public boolean checkValidate(){
        if(txtMaXuatXu.getText().isBlank() || txtTenXuatXu.getText().isBlank()){
            JOptionPane.showMessageDialog(this, "Dữ liệu không được để trống");
            return false;
        }
        if(txtMaXuatXu.getText().trim().length() > 20){
            JOptionPane.showMessageDialog(this, "Mã chức vụ không dược quá 20 ký tự");
            return false;
        }
        
        if(txtTenXuatXu.getText().trim().length() > 30){
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtTenXuatXu, javax.swing.GroupLayout.DEFAULT_SIZE, 411, Short.MAX_VALUE))))
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        if(checkValidate()){
            if(cvService.checkMa(txtMaXuatXu.getText().trim())){
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(tblXuatXu.getSelectedRow() < 0){
            ...
            if(chon == JOptionPane.YES_OPTION){
                JOptionPane.showMessageDialog(this, cvService.deleteCV(txtMaXuatXu.getText().trim()));
                loadTable();
            }
        }
