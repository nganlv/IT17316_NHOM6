...
private void loadTableTh() {
        ...
        for (QlThuongHieu th : listTh) {
            model.addRow(new Object[]{th.getId(), th.getMa(), th.getTen()});
        }
        tblTh.setModel(model);
    }
    /**
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (txtMa.getText().trim().isEmpty() || txtTen.getText().trim().isEmpty()) {
            ...
            iThuongHieuSer.deleteThs(txtMa.getText());
...
private void fillTh(int index){
    List<QlThuongHieu> listTh=iThuongHieuSer.getAllThs();
    txtMa.setText(listTh.get(index).getMa());
    txtTen.setText(listTh.get(index).getTen());
}
