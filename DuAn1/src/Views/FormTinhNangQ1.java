 ...
 * @author levan
 */
public class FormTinhNangQ1 extends javax.swing.JFrame {

    private final ITinhNangQ1 iPKService = new TinhNangQService1();

    /**
     * Creates new form FormNSX
     */
    public FormTinhNangQ1() {
        initComponents();
    ...
    private void loadTable() {
        ...
        List<QuanLyTinhNangQ1> listSx = iPKService.getAll();
        if (listSx == null) {
            JOptionPane.showMessageDialog(this, "Rỗng");
            return;
        }
        for (QuanLyTinhNangQ1 sx : listSx) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        try {
            QuanLyTinhNangQ1 sx=new QuanLyTinhNangQ1();
...
txtid.setText(tbbang.getValueAt(index, 0).toString());//       // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTinhNangQ1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTinhNangQ1().setVisible(true);
            }
        });
    }
